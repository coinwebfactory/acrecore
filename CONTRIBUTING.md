Contributing to Acre Core
============================

The Acre Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Acre Core project, and is not to be
confused with overall Acre Network Protocol consensus changes.

Whether a pull request is merged into Acre Core rests with the project merge
...
Patches that change Acre consensus rules are considerably more involved than
...
Where a patch set proposes to change the Acre consensus, it must have been
...
The project leader is the release manager for each Acre Core release.
