...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Acre features */
        {"acre", "masternode", &masternode, true, true, false},
        {"acre", "listmasternodes", &listmasternodes, true, true, false},
        {"acre", "getmasternodecount", &getmasternodecount, true, true, false},
        {"acre", "masternodeconnect", &masternodeconnect, true, true, false},
        {"acre", "masternodecurrent", &masternodecurrent, true, true, false},
        {"acre", "masternodedebug", &masternodedebug, true, true, false},
        {"acre", "startmasternode", &startmasternode, true, true, false},
        {"acre", "createmasternodekey", &createmasternodekey, true, true, false},
        {"acre", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"acre", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"acre", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"acre", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"acre", "getmasternodescores", &getmasternodescores, true, true, false},
        {"acre", "mnbudget", &mnbudget, true, true, false},
        {"acre", "preparebudget", &preparebudget, true, true, false},
        {"acre", "submitbudget", &submitbudget, true, true, false},
        {"acre", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"acre", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"acre", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"acre", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"acre", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"acre", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"acre", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"acre", "checkbudgets", &checkbudgets, true, true, false},
        {"acre", "mnsync", &mnsync, true, true, false},
        {"acre", "spork", &spork, true, true, false},
        {"acre", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"acre", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use acred, or the -server option to acre-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> acre-cli " + methodname + " " + args + "\n";
}
