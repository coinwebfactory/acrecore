                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Acre Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Acre address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and acre: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zACRE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Acre Core"), this);
    aboutAction->setStatusTip(tr("Show information about Acre Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Acre"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Acre addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Acre addresses"));
    ...
    openAction->setStatusTip(tr("Open a Acre: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Acre Core help message to get a list with possible Acre command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Acre Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Acre network", "", count));
}
...
{
    QString strTitle = tr("Acre Core"); // default title
