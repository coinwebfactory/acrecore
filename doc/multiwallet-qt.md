...
In order to support loading of multiple wallets in acre-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is acre.cpp.
...
Changes to acre.cpp
----------------------
acre.cpp is the entry point into acre-qt, and as such, will require some minor modifications to provide hooks for
